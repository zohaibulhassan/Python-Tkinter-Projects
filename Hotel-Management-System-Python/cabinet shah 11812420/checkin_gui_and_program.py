...
class HOTEL_MANGMENT_checkin:
    ...
    def __init__(self):
        ...
        self.Frame1.configure(highlightcolor="white")
        ...
        self.Message4.configure(background="blue")
        self.Message4.configure(font=font13)
        self.Message4.configure(foreground="white")
        ...
        self.Message5.configure(background="blue")
        self.Message5.configure(font=font13)
        self.Message5.configure(foreground="white")
        ...
        self.Checkbutton1.configure(background="blue")
        ...
        self.Checkbutton2.configure(background="blue")
        ...
        self.Checkbutton3.configure(background="blue")
        ...
        self.Checkbutton4.configure(background="blue")
        ...
        self.Checkbutton5.configure(background="blue")
        ...
        self.Message7.configure(background="blue")
        ...
        self.Message8.configure(background="blue")
        self.Message8.configure(font=font13)
        self.Message8.configure(foreground="white")
